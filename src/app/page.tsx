...
// ─── HERO SECTION — Full-viewport cinematic editorial ──────
function HeroSection() {
  ...
  const overlayOpacity = useTransform(scrollYProgress, [0, 0.4], [0.15, 0.5]);
  ...
  return (
    <section ref={ref} className="relative h-screen w-full overflow-hidden bg-void">
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(ellipse at 70% 30%, rgba(196,90,44,0.06) 0%, transparent 55%)",
        }}
      />
      ...
      >
        ...
        >
          <Image
            ...
            style={{
              filter: "saturate(0.8) sepia(0.08) contrast(1.1) brightness(0.88)",
            }}
            sizes="120vw"
            priority
          />
      ...
      <div className="absolute inset-0 z-[5] pointer-events-none" style={{
        background: "rgba(196,90,44,0.04)",
        ...
        <div className="px-6 pb-24 md:px-12 md:pb-20 lg:px-20 lg:pb-24 max-w-[900px]">
          ...
          <div className="pointer-events-auto">
            ...
            >
              ...
              >
                <span className="block font-display text-[0.85rem] md:text-[1rem] font-[300] tracking-[0.3em] text-ember/80 mb-3">
                  A
                </span>
              </motion.div>

              {/* Line 2: "Kitchen" — massive */}
              <motion.div
                variants={{
              ...
              >
                <span className="block font-display font-[100] text-linen" style={{
              ...
              <motion.div
                ...
                transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
              >
                <span className="block font-display font-[100] text-linen/50 mt-2 md:mt-3" style={{
              ...
              {/* Line 4: "furniture." — large, bold weight */}
              <motion.div
                variants={{
                  hidden: { opacity: 0, y: 25, filter: "blur(8px)" },
                  visible: { opacity: 1, y: 0, filter: "blur(0px)" },
                ...
                transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
              >
                <span className="block font-display font-[900] text-linen mt-1" style={{
          ...
          >
            ...
            <Link
              href="/collections"
              className="group inline-flex items-center gap-2 font-body text-[0.7rem] font-[300] tracking-[0.12em] text-linen/35 transition-colors duration-500 hover:text-ember/80"
            >
              Explore Collection
      ...
      <AnimatePresence>
        {scrollCueVisible && (
          ...
          >
            <span className="font-body text-[0.5rem] font-[300] tracking-[0.3em] uppercase text-linen/20">
              Scroll
            </span>
            <motion.div
